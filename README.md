...
### A. Menambahkan Favicon

1. Icon baru yang telah ingin ditambahkan

   ![Icon](<public/screenshots/01 - Icon.png>)

2. Output pada website

   ![Tampilan custom favicon pada website](<public/screenshots/01 - Add Custom Favicon.png>)

### B. Menambahkan Metadata untuk SEO

1. Tampilan pada halaman **Tentang Saya**
